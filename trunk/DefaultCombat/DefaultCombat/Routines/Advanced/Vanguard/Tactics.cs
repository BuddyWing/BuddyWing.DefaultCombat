...
{//by protpally
    public static class VanguardTactics
    {
        ...
        public static Composite VanguardTacticsPull()
        {
            return VanguardTacticsCombat();
        ...
        [Class(CharacterClass.Trooper, AdvancedClass.Vanguard, SkillTreeId.VanguardTactics)]
        public static Composite VanguardTacticsCombat()
        {
            return new PrioritySelector(
                ...
                new Decorator(ret => AllCombat,
                    new PrioritySelector(
                        ...
                        new Decorator(ret => Burn || BuddyTor.Me.HasBuff("Critical Boost") || BuddyTor.Me.HasBuff("Power Boost"),
                            new PrioritySelector(
                                Spell.Cast("Gut", ret => BuddyTor.Me.CurrentTarget.Debuffs.FirstOrDefault(B => B.Name == "Bleeding (Physical)" && B.Caster.Name == BuddyTor.Me.Name) == null),
                                Spell.Cast("Gut", ret => BuddyTor.Me.ResourceStat >= 2 && BuddyTor.Me.CurrentTarget.Debuffs.FirstOrDefault(B => B.Name == "Bleeding (Physical)" && B.Caster.Name == BuddyTor.Me.Name) != null && BuddyTor.Me.CurrentTarget.Debuffs.FirstOrDefault(B => B.Name == "Bleeding (Physical)" && B.Caster.Name == BuddyTor.Me.Name).TimeLeft.Seconds < 4),
                                Spell.WaitForCast(),
                                ...
                                new Decorator(ret => BuddyTor.Me.CurrentTarget.Distance <= 1f,
                                    new Sequence(
                                        ...
                                        Spell.Cast("Pulse Cannon", ret => BuddyTor.Me.CurrentTarget.Distance <= 1f)//Frontal Cone
                                    )
                                ),
                                Spell.Cast("High Impact Bolt", ret => BuddyTor.Me.ResourceStat >= 2 && BuddyTor.Me.HasBuff("Combat Tactics")),
                                Spell.Cast("Stockstrike", ret => BuddyTor.Me.ResourceStat >= 2 && BuddyTor.Me.CurrentTarget.Distance <= .5f && BuddyTor.Me.HasBuff("Battering Ram")),
                                Spell.Cast("Fire Pulse", ret => BuddyTor.Me.ResourceStat >= 2),
                                Spell.Cast("Stockstrike", ret => BuddyTor.Me.ResourceStat >= 2 && BuddyTor.Me.CurrentTarget.Distance <= .5f),
                                Spell.Cast("High Impact Bolt", ret => BuddyTor.Me.ResourceStat >= 2),
        ...
        public static Composite VanguardTacticsOutOfCombat()
        {
            return new PrioritySelector(
                Spell.Cast("Recharge and Reload", ret => BuddyTor.Me.ResourceStat <= 6 || BuddyTor.Me.HealthPercent < 100),
                Spell.BuffSelf("High Energy Cell"),
                Spell.BuffSelf("Plasma Cell", ret => !AbilityManager.HasAbility("High Energy Cell")),

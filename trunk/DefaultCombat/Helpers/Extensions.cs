...
namespace DefaultCombat.Helpers
{
    public static class Extensions
    {
        ...
        public static bool IsValidTarget(this TorCharacter c)
        {
            ...
            {
                // If whatever exception occurs during a script call to determine any of the above,
                // we can't guarantee that the target is actually valid. Just return false to be safe.
                return false;
            }
        }

        ...
        public override Composite Cooldowns
        {
            get
            {
                return new PrioritySelector(
                    ...
                    Spell.Cast("Zen", ret => !Me.HasBuff("Zen") && Me.CurrentTarget.HasDebuff("Burning (Overload Saber)")),
        ...
        public override Composite SingleTarget
        {
            get
            {
                return new PrioritySelector(
                    ...
                    //Spell.Cast("Slash", ret => Me.ActionPoints >= 8 && Me.CurrentTarget.HasDebuff("Burning (Cauterize)")),
					Spell.Cast("Slash", ret => Me.ActionPoints >= 9 || Me.CurrentTarget.DebuffTimeLeft("Burning (Cauterize)") <= 3), //should AP be 8 , this requires Spiteful Saber Tactical

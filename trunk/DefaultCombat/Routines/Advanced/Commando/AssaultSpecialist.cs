        ...
        public override Composite Cooldowns
        {
            get
            {
                return new PrioritySelector(
                    ...
                    Spell.Cast("Recharge Cells", ret => Me.ResourceStat <= 40),
            ...
            get
            {
                return new Decorator(ret => Targeting.ShouldAoe,
                    new PrioritySelector(
                        ...
                        Spell.DoT("Serrated Bolt", "Bleeding"),
                        Spell.DoT("Incendiary Round", "Burning (Incendiary Round)"),
                        Spell.Cast("Plasma Grenade", ret => !Me.CurrentTarget.HasDebuff("Radiation Burns")),
                        Spell.Cast("Sticky Grenade", ret => !Me.CurrentTarget.HasDebuff("Sticky Grenade")),
                        Spell.Cast("Explosive Round", ret => Me.HasBuff("Hyper Assault Rounds")),
